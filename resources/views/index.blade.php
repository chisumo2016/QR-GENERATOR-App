            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="call-to-action">
                        <a href="user/register.html" class="btn btn-primary" style="border-radius: 50px; font-size: 17px;">&emsp;Get Started&emsp;</a>

                        <a href="user/register.html" class="btn btn-primary" style="border-radius: 50px; font-size: 17px;">&emsp;QR Decoder&emsp;</a>
    ...
    <section class="infinity-cta">
        <div class="container">
            <div class="row stats">
                ...
                <div class="col-md-12">
                    <a href="user/register.html" class="infbtn">Get Started</a>
                </div>
            </div>
        </div>
    </section>
